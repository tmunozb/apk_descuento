...
public class FragmentCartas extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.cartas_fragment, container, false);
    ...
    private void event() {
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<String> call = descuentoRepository.saveCarta(descuento, sharedPreferences.getString("token", null));
                call.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        if (response.isSuccessful() && response.code() == 200) {
                            Toast.makeText(getContext(), "Se agrego el descuento", Toast.LENGTH_LONG).show();
                            String msg = getResources().getString(R.string.msjwhtspcarta) + " " + descuento.getPlaca();
                            limpiar();
