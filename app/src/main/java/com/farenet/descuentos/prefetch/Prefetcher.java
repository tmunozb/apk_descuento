package com.farenet.descuentos.prefetch;
...
/**
 * Dispara cargas en segundo plano luego del login para que las pantallas
 * tengan los datos listos desde cache/Realm (stale-while-revalidate).
 */
